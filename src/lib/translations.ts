...
const dict: Translations = {
  ...
  'form.name.hint': { ru: 'Начните вводить популярный сервис — иконка и данные подтянутся из базы. Или добавьте свой платёж вручную.', en: 'Start typing a popular service — its icon and details autofill from the catalog. Or add your own payment manually.' },
  ...
  'form.managementUrl': { ru: 'Ссылка на удаление подписки', en: 'Cancellation / unsubscribe link' },
  ...
  'form.extra': { ru: 'Дополнительные настройки', en: 'Additional settings' },
  ...
  'score.factorDupesBad':       { ru: 'Возможные дубли: {{n}}', en: 'Possible duplicates: {{n}}' },
  ...
  'score.factorTrialsTracked':  { ru: 'Отслеживаешь {{n}} пробных — норм', en: 'Tracking {{n}} trials — all good' },
  'score.factorTrialsBad':      { ru: '{{n}} пробных скоро спишутся', en: '{{n}} trials charging soon' },
